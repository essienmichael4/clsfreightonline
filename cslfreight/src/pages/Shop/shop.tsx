...
const Shop = () => {
  ...
  const products: Product[] = [{
      ...
      price: 850,
      image:
        'https://lh3.googleusercontent.com/aida-',
      badgeColor: 'primary',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: 1650,
      image:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuCdIAwGRcj9eqo5DrNYL_A72Mz5OD82R64obWjXZg9UfO7gUTM3aMNQsuml6flJ6KBL2w_fUDjs_VUzKHc_eaGqrpsi9MQB3e75no3xdom2lXXivvmr5hWqa5Ua3PCRBLEZMfQ-zhpmwrrZGtEHR0awqcQ8GO1O_p7bbI2AlXbVrBhn5wSPFA7_6hz5LUh-JX_zL_HojnhDi8Iubmmo-8xlQxxXWo1IaevznC3INqc5IHoRilNKVUd0uwB6W-AY2Ma0DKxK4A4PJtWo',
    },
    {
      id: 5,
      name: 'Luminous Core',
  ...
  return (
    <div className="bg-background text-foreground font-body min-h-screen">
      <main className="pb-20">
        {/* Hero Section */}
        <header className="px-8 md:px-16 py-12 flex flex-col md:flex-row items-end justify-between gap-8">
          <div className="max-w-3xl">
            <p className="text-primary font-label font-semibold tracking-widest uppercase text-xs mb-4">
              Curated Collections
            </p>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter leading-none text-foreground">
              Premium <br /> <span className="text-primary">Shipping Solutions</span>
            </h1>
          </div>
          <div className="pb-4">
            <p className="text-muted-foreground font-body max-w-xs text-sm leading-relaxed opacity-80">
              Experience world-class freight forwarding services. Explore our latest curated logistics packages and shipping solutions.
            </p>
          </div>
        </header>
            ...
            <div className="lg:col-span-3">
              ...
              {filteredProducts.length > 0 ? (
                filteredProducts.map((product, index) => (
                  ...
                  >
                    <div className="aspect-[3/4] overflow-hidden rounded-lg bg-muted mb-6 relative">
                      <img
                        src={product.image}
                        alt={product.name}
