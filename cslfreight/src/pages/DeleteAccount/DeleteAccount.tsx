      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-gray-600">
            <strong>App name:</strong> CSL Freight Mobile
          </p>
          <p className="text-gray-600">
            <strong>Developer:</strong> CSL Freight GH
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <p className="text-gray-700 leading-relaxed">
            ...
            <strong> CSL Freight Mobile</strong> can request deletion of their account and associated data.
          </p>
        </div>
        ...
        <Section title="How to Request Account Deletion">
          ...
          <SubSection title="Option 1: In‑App Request (Recommended)">
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>Open the <strong>CSL Freight Mobile</strong> app</li>
          ...
          <SubSection title="Option 2: Email Request">
            ...
            <div className="bg-gray-100 p-4 rounded border-l-4 border-gray-400 mb-4 text-gray-800">
              <strong>Account Deletion Request – CSL Freight Mobile</strong>
            </div>
