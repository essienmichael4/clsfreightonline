            ...
            <div className="px-6 mt-10 rounded-lg">
                ...
                <div className="mt-8">
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                        ...
                        <p> We are a freight forwarding company and are responsible for your package collection, inspection, consolidation, container booking & ongoing customs clearance from the country of origin to the country of destination.</p>
                    </div>
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                        <h4 className="text-3xl text-gray-500"># 02</h4>
                        <p> The client(you) are responsible for packaging of your product, correct indication of your packages & timely payment of all customs & freight charges.</p>
                    </div>
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                        <h4 className="text-3xl text-gray-500"># 03</h4>
                        <p>We(CSL) reserves the right to reject hazardous, prohibited or improperly packaged cargo at our warehouse.</p>
                    </div>
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                        <h4 className="text-3xl text-gray-500"># 04</h4>
                        <p> Clients are responsible for insurance of their packages from port of origin to the country of destination but CSL is responsible only for packages within our warehouses.</p>
                    </div>
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                    ...
                    <div className="mt-4 gap-4 flex flex-col p-4 md:w-3/4">
                        <h4 className="text-3xl text-gray-500"># 24</h4>
