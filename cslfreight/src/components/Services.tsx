  ...
  return (
    <>
        <div className="mt-20 px-6 relative min-h-[800px]">
            ...
            <span className="text-blue-700 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase bg-neutral-100/80">
                Our Services
            </span>
            ...
            <div className="flex flex-wrap">
                ...
                <div className="rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 bg-white shadow-md">
                    <img
                    src={ocean}
                    alt="Cargo ship carrying containers for ocean freight"
                    ...
                    <div className="text-neutral-500">
                        <p className="mb-3">
                        Reliable and cost-effective ocean freight services for large
                        shipments.
                        </p>
                    </div>
                    </div>
                ...
                <div className="rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 bg-white shadow-md">
                    <img
                    src={air}
                    alt="Airplane flying for international air freight delivery"
                    className="rounded-t-lg aspect-video w-full"
                    />
                    <div className="mt-4 text-left p-4">
                    ...
                    <div className="text-neutral-500">
                        <p className="mb-3">
                        Fast and efficient air freight services for time-sensitive
                        shipments.
                        </p>
                    </div>
                    </div>
                ...
                <div className="rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 bg-white shadow-md">
                    <img
                    src={land}
                    alt="Customs clearance process with paperwork and cargo trucks"
                    className="rounded-t-lg aspect-video w-full"
                    />
                    <div className="mt-4 text-left p-4">
                    ...
                    <div className="text-neutral-500">
                        <p className="mb-3">
                        Expert assistance with customs clearance to ensure smooth and
                        timely delivery.
                        </p>
                    </div>
                    </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-2">
                ...
                <div className="flex flex-col">
                    ...
                    <p>
                    Our commitment to delivery ensures that your cargo arrives on time
                    every time.
                    </p>
                </div>
                </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-2">
                ...
                <div className="flex flex-col">
                    ...
                    <p>
                    Our customer-centric approach means personalized solutions for
                    your unique cargo.
                    </p>
                </div>
                </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-2">
                ...
                <div className="flex flex-col">
                    ...
                    your shipment, ensuring you are in control.
                    </p>
                </div>
                </div>
            </div>
