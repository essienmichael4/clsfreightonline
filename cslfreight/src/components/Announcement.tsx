...
const Announcement = () => {
  ...
  return (
      <div className={`${show ? 'flex' : 'hidden'} rounded-md absolute z-50 top-20 left-6 sm:left-1/3 md:left-2/4 lg:left-2/3 right-6 p-8 items-center justify-center bg-orange-500`} ref={handleElementRef}>
