...
const EditLoading = ({item, trigger}:Props) => {
    const [open, setOpen] = useState(false)
    const axios_instance_token = useAxiosToken()
    const queryClient = useQueryClient()

    const form = useForm<EditLoadingSchemaType>({
    ...
    const onSubmit = (data:EditLoadingSchemaType)=>{
        toast.loading("Editing ccontainer loading...", {
            id: "add-address"
        })
        mutate(data)
    }
