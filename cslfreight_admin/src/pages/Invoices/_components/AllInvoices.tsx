...
import DateRangeCell from "@/components/DataTable/DateRangeCell"
...
const AllInvoices = ({status, search, page, limit, setLimit, setPage}:FilterProps) => {
    const ticketsQuery = useInvoices(page, limit, search, status)
    ...
    const columns:ColumnDef<Invoice>[] =[{
        ...
        accessorKey: "eta",
        header:({column})=>(<DataTableColumnHeader column={column} title='Issued & ETA Date' />),
        cell:({row}) => <div>
            <DateRangeCell startDate={row.original.issuedDate} endDate={row.original.eta}/>
        </div>
    },{
        accessorKey: "total",
