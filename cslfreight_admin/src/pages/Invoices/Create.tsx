...
import type { InvoiceAddressType, WarehouseType, HelplineType, Client, Package, BankType } from "@/lib/types"
...
const Create = () => {
    ...
    useEffect(() => {
        // Whenever loaded date changes, reset selected rows
        setSelectedRows([]);
    }, [createDate]);
        ...
        <div className="container px-4 mx-auto">
            <Breadcrumb className="my-2">
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                    <BreadcrumbPage className="text-xs">create</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            <div>
                <div className="flex flex-wrap">
                    <div className="w-full lg:w-1/3">
                        <h4 className="font-semibold text-lg">Create New Invoice</h4>
