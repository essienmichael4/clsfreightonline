...
import type { HelplineType } from '@/lib/types'
...
const EditHelpline = ({trigger, helpline}:Props) => {
    ...
    const editHelpline = async (data:AddHelplineSchemaType)=>{
        const response = await axios_instance_token.patch(`/settings/helplines/${helpline.id}`, {
            ...data
        },)
    ...
    const {mutate, isPending} = useMutation({
        mutationFn: editHelpline,
        onSuccess: ()=>{
            toast.success("Helpline edited successfully", {
                id: "edit-helpline"
            })
    ...
    const onSubmit = (data: AddHelplineSchemaType)=>{
        toast.loading("Editing helpline...", {
            id: "edit-helpline"
        })
        mutate(data)
    }
