                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
                    ...
                    <View style={styles.card}>
                        ...
                        {(packageDetail.data?.loaded || packageDetail.data?.received || packageDetail.data?.vessel || packageDetail.data?.eta || packageDetail.data?.departure) && (
                            <>
                                <View style={styles.divider} />
                                <DetailRow label="Received" value={packageDetail.data?.received} />
                                <DetailRow label="Loaded" value={packageDetail.data?.loaded} />
                                <DetailRow label="Vessel" value={packageDetail.data?.vessel} />
                                <DetailRow label="Departure" value={packageDetail.data?.departure} />
                                <DetailRow label="ETA" value={packageDetail.data?.eta} />
                            </>
                        )}
