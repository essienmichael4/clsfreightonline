...
export default function DeleteAccountScreen() {
    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            ...
            await axios_instance_token.delete(`/users/clients/${auth?.id}`, {
                data: {
    ...
    const OptionItem = ({ number, title, items }: { number: number; title: string; items: string[] }) => (
        <View style={styles.optionItem}>
            ...
            <View style={styles.optionContentContainer}>
                {items.map((item, index) => (
                    <View key={index} style={styles.optionLine}>
                ...
                >
                    ...
                    <View style={styles.infoBox}>
                        ...
                        <View style={styles.infoContent}>
                            <Text style={styles.infoTitle}>CSL Freight Mobile</Text>
                            <Text style={styles.infoText}>Developer: CSL Freight GH</Text>
                        </View>
                    </View>
                    ...
                    <SectionContent>
                        ...
                        <View style={styles.optionBox}>
                            ...
                            <View style={styles.optionSteps}>
                                <BulletItem text="Open the CSL Freight Mobile app" />
                        ...
                        <View style={styles.optionBox}>
                            ...
                            <View style={styles.optionSteps}>
                                ...
                                <View style={styles.emailBox}>
                                    <Text style={styles.emailAddress}>support@cslfreightgh.com</Text>
                                </View>
                                <Text style={styles.optionSubtitle}>Use the subject line:</Text>
                                <View style={styles.subjectBox}>
                                    <Text style={styles.subjectText}>Account Deletion Request – CSL Freight Mobile</Text>
                                </View>
                    ...
                    <SectionContent>
                        ...
                        <BulletItem text="Shipment history linked to your account" />
                        <BulletItem text="Saved addresses and preferences" />
                        <BulletItem text="Uploaded documents or images" />
                    </SectionContent>
                    ...
                    <SectionContent>
                        <BulletItem text="Account deletion requests are processed within 7–14 business days" />
                        <BulletItem text="Legally required records may be retained for up to 6 years, after which they are permanently deleted" />
                    </SectionContent>
                    ...
                    <SectionContent>
                        <Text style={styles.bulletText}>
                            Once your deletion request is completed, you will receive a confirmation email. After deletion:
                        </Text>
                    ...
                    <SectionContent>
                        ...
                        <View style={styles.contactBox}>
                            ...
                            <Text style={styles.contactEmail}>support@cslfreightgh.com</Text>
                        </View>
                    </SectionContent>
...
const styles = StyleSheet.create({
    ...
    deleteButton: {
        ...
        alignItems: 'center',
        justifyContent: 'center',
        boxShadow: `0 2px 8px ${colors.error}33`,
        elevation: 4,
        gap: spacing.sm,
    },
    deleteButtonText: {
